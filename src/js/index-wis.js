...
wisId = wisId ? wisId : "43c9e86f0684c7f27e80d8b46eb80128";     //修改为自己的wisId
var pageNum = 0;
...
tisId = tisId ? tisId : "d8ee78aaba905764b326af6a90ba3653";     //修改为自己的tisId
var userMap = {}
...
lssApp = lssApp ? lssApp : "test-lss";   //学生端lssApp
lssStream = lssStream ? lssStream : "student";      //学生端lssStream
thApp = thApp ? thApp : "test-lss";      //教师端thApp
thStream = thStream ? thStream : "teacher";         //教师段thStream
adUserId = adUserId ? adUserId : "13932";            //奥点云帐号Id
